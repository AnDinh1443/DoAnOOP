 ...
 * @author 84907
 */
public class GiaoTrinh_Detail extends javax.swing.JDialog {
public ArrayList<GiaoTrinh> list_GT;
    DefaultTableModel model;
    Product home;
    public GiaoTrinh_Detail(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
   ...
   public void getData(GiaoTrinh gt){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GiaoTrinh_Detail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GiaoTrinh_Detail dialog = new GiaoTrinh_Detail(new javax.swing.JFrame(), true);
