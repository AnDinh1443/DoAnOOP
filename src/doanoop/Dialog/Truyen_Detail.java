 ...
 * @author 84907
 */
public class Truyen_Detail extends javax.swing.JDialog {

    public ArrayList<Truyen> list_TR;
    DefaultTableModel model;
    public Truyen_Detail(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        list_TR = new ArrayList<>();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Truyen_Detail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Truyen_Detail dialog = new Truyen_Detail(new javax.swing.JFrame(), true);
