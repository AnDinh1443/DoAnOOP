 ...
 * @author 84907
 */
public class GiaoKhoa_Detail extends javax.swing.JDialog {

    /**
     * Creates new form GiaoKhoa_Detail
     */
    public GiaoKhoa_Detail(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GiaoKhoa_Detail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GiaoKhoa_Detail dialog = new GiaoKhoa_Detail(new javax.swing.JFrame(), true);
